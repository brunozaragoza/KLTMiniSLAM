...
public:
    ...
    void setKeyPoints(std::vector<cv::KeyPoint> &pts);
    std::vector<LandmarkStatus> &LandmarkStatuses();
    void setLandmarkStatuses(const std::vector<LandmarkStatus> input);
    /*
    ...
    std::vector<cv::KeyPoint> GetKeypointsWithStatus(
        ...
        std::vector<std::shared_ptr<MapPoint>> GetLandmarkPointersWithStatus(
