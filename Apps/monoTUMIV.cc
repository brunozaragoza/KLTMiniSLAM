 ...
 */
 ...
 int main(int argc, char **argv){
     ...
     if(argc != 3){
         ...
         cerr << "\t./mono_euroc <dataset_path> <tumfoldertimestamps_path> <groundtruth_path>" << endl;
     ...
     string timstampsPath = argv[2];
     
     TUMVILoader sequence(datasetPath,timstampsPath,datasetPath + "/mav0/im0/data.csv");
